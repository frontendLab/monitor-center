module.exports = {
  ...
  groupDeveLoperMail: {
    '0': 'zhouxiaojiang@startdt.com',
    '1': 'hanjiaping@startdt.com,zhouxiaohao@startdt.com,wangjue@startdt.com',
    '2': 'laixuejiao@startdt.com,huangzhenhua@startdt.com,jiangzhengxing@startdt.com',
    '3': 'zhuzheng@startdt.com,xuhuihui@startdt.com,wangjie@startdt.com,zhengzhuanzhuan@startdt.com',
    '4': 'fangbing@startdt.com,fengjunyuan@startdt.com,shiyizhou@startdt.com',
    '5': 'guohelong@startdt.com'
  },
  // api_monitor表的字段
  apiMonitorKeys: ['url', 'desc', 'response', 'param', 'group', 'app', 'ua', 'referer', 'date', 'others', 'type', 'status']
}
